    ...
    return new class implements Bootstrap
    {
        public function router(array $routes): \pulledbits\Router\Router
        {
            ...
            return new \pulledbits\Router\Router(array_map(function ($v) use ($resources) {
                ...
                return new $class(
                    $resources,
                    $resources->phpview(__DIR__ . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . str_replace(NAMESPACE_SEPARATOR, DIRECTORY_SEPARATOR, $v)),
                    $resources->responseFactory()
                );
            }, $routes));
        }
