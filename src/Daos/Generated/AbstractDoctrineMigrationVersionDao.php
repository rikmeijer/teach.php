 ...
 * If you need to perform changes, edit the DoctrineMigrationVersionDao class instead!
 */
...
use rikmeijer\Teach\Beans\DoctrineMigrationVersion;

/**
 * The AbstractDoctrineMigrationVersionDao class will maintain the persistence of DoctrineMigrationVersion class into the doctrine_migration_versions table.
 *
 */
class AbstractDoctrineMigrationVersionDao
{
     ...
     */
    public function save(DoctrineMigrationVersion $obj): void
    {
     ...
     *
     * @return DoctrineMigrationVersion[]|ResultIterator
     */
     ...
     */
    public function getById(string $id, bool $lazyLoading = false) : DoctrineMigrationVersion
    {
        return $this->tdbmService->findObjectByPk('doctrine_migration_versions', ['version' => $id], [], $lazyLoading);
    }
    
    /**
     * Deletes the DoctrineMigrationVersion passed in parameter.
     *
     * @param DoctrineMigrationVersion $obj object to delete
     * @param bool $cascade if true, it will delete all object linked to $obj
     */
    public function delete(DoctrineMigrationVersion $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
     ...
     * @param mixed[] $parameters The parameters associated with the filter
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return DoctrineMigrationVersion|null
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?DoctrineMigrationVersion
    {
     ...
     * @return DoctrineMigrationVersion|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?DoctrineMigrationVersion
    {
