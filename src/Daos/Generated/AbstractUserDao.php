...
/**
 * The AbstractUserDao class will maintain the persistence of User class into the users table.
 *
 */
class AbstractUserDao
{
     ...
     *
     * @param User $obj The bean to save.
     */
    ...
    /**
     * Get User specified by its ID (its primary key)
    ...
    /**
     * Deletes the User passed in parameter.
     *
     * @param User $obj object to delete
     * @param bool $cascade if true, it will delete all object linked to $obj
     */
    public function delete(User $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
    ...
    /**
     * Get a list of User specified by its filters.
     *
    ...
    /**
     * Get a list of User from a SQL query.
    ...
    /**
     * Get a single User specified by its filters.
     *
     * @param mixed $filter The filter bag (see TDBMService::findObjects for complete description)
     * @param mixed[] $parameters The parameters associated with the filter
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return User|null
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?User
    {
     ...
     * @return User|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?User
    {
