...
class DocumentPartsTest extends \PHPUnit_Framework_TestCase
{
    public function testDocument()
    {
        ...
        $object = new DocumentParts(new Lesplan\Beginsituatie('Blok 1 / Week 1 / Les 1', [
            'doelgroep' => [
