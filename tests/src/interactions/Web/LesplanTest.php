...
class LesplanTest extends \PHPUnit_Framework_TestCase
{
    public function testDocument()
    {
        ...
        $object = new Lesplan("HBO-informatica (voltijd)", "Programmeren 1", $contactmoment, $introductie = new Lesplan\Fase('2', "Introductie"), $kern = new Lesplan\Fase('2', 'Kern'), $afsluiting = new Lesplan\Fase('2', "Afsluiting"));
