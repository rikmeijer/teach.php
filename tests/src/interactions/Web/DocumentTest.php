...
class DocumentTest extends \PHPUnit_Framework_TestCase
{
    public function testDocument()
    {
        ...
        $object = new Document("Lesplan Programmeren 1", "HBO-informatica (voltijd)", $contactmoment, $introductie = new Lesplan\Fase('2', "Introductie"), $kern = new Lesplan\Fase('2', 'Kern'), $afsluiting = new Lesplan\Fase('2', "Afsluiting"));
