...
class DocumentTest extends \PHPUnit_Framework_TestCase
{
    public function testDocument()
    {
        ...
        $object = new Document("Lesplan Programmeren 1", "HBO-informatica (voltijd)");
        $object->addOnderdeel(new Lesplan\Beginsituatie('Blok 1 / Week 1 / Les 1', [
            'doelgroep' => [
        ...
        $object->addOnderdeel(new Lesplan\Fase('2', "Introductie"));
        $object->addOnderdeel(new Lesplan\Fase('2', "Kern"));
        $object->addOnderdeel(new Lesplan\Fase('2', "Afsluiting"));
