...
class ContactmomentTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGenerateHTMLLayout()
    {
        ...
        $this->assertEquals('h3', $html[2][HTMLFactory::TAG]);
        $this->assertEquals("Benodigde media", $html[2][HTMLFactory::CHILDREN][0]);
        $this->assertEquals("ul", $html[3][HTMLFactory::TAG]);

        $this->assertEquals("li", $html[3][HTMLFactory::CHILDREN][0][HTMLFactory::TAG]);
        $this->assertEquals('filmfragment matrix', $html[3][HTMLFactory::CHILDREN][0][HTMLFactory::CHILDREN][0]);
        $this->assertEquals("li", $html[3][HTMLFactory::CHILDREN][1][HTMLFactory::TAG]);
        $this->assertEquals('countdown timer voor toepassingsfases (optioneel)', $html[3][HTMLFactory::CHILDREN][1][HTMLFactory::CHILDREN][0]);

        $this->assertEquals('h3', $html[4][HTMLFactory::TAG]);
        $this->assertEquals("Leerdoelen", $html[4][HTMLFactory::CHILDREN][0]);
        $this->assertEquals("p", $html[5][HTMLFactory::TAG]);
        $this->assertEquals("Na afloop van de les kan de student:", $html[5][HTMLFactory::CHILDREN][0]);
        
        $this->assertEquals("ol", $html[6][HTMLFactory::TAG]);
        
        $this->assertEquals("li", $html[6][HTMLFactory::CHILDREN][0][HTMLFactory::TAG]);
        $this->assertEquals('Zelfstandig eclipse installeren', $html[6][HTMLFactory::CHILDREN][0][HTMLFactory::CHILDREN][0]);
        $this->assertEquals("li", $html[6][HTMLFactory::CHILDREN][1][HTMLFactory::TAG]);
        $this->assertEquals('Java-code lezen en uitleggen wat er gebeurt', $html[6][HTMLFactory::CHILDREN][1][HTMLFactory::CHILDREN][0]);
    }
    ...
    public function testGenerateHTMLLayoutNoMedia()
    {
        ...
        $this->assertEquals('h3', $html[2][HTMLFactory::TAG]);
        $this->assertEquals("Leerdoelen", $html[2][HTMLFactory::CHILDREN][0]);
        $this->assertEquals("p", $html[3][HTMLFactory::TAG]);
